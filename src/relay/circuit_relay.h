...
typedef enum {
    RELAY_STATUS_UNUSED = 0,
    RELAY_STATUS_OK = 100,
    RELAY_STATUS_RESERVATION_REFUSED = 200,
    RELAY_STATUS_RESOURCE_LIMIT_EXCEEDED = 201,
    RELAY_STATUS_PERMISSION_DENIED = 202,
    RELAY_STATUS_CONNECTION_FAILED = 203,
