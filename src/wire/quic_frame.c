...
int speer_qf_encode_ack(speer_qf_writer_t* w, uint64_t largest, uint64_t delay, const uint64_t* gaps_lengths, size_t pairs) {
...
int speer_qf_encode_stream(speer_qf_writer_t* w, uint64_t stream_id, uint64_t offset, const uint8_t* data, size_t len, int fin) {
...
int speer_qf_encode_connection_close(speer_qf_writer_t* w, uint64_t error_code, uint64_t frame_type, const char* reason) {
...
int speer_qf_encode_new_connection_id(speer_qf_writer_t* w, uint64_t seq, uint64_t retire_prior_to,
                                       const uint8_t* cid, size_t cid_len, const uint8_t reset_token[16]) {
