...
static const fe25519 ge_base_x = {
    0xd51a, 0x8f25, 0x2d60, 0xc956, 0xa7b2, 0x9525, 0xc760, 0x692c,
    0xdc5c, 0xfdd6, 0xe231, 0xc0a4, 0x53fe, 0xcd6e, 0x36d3, 0x2169
};

static const fe25519 ge_base_y = {
...
static const int64_t L_LIMBS[32] = {
...
static int ge_frombytes_negate_vartime(ge_p3* h, const uint8_t* s) {
    ...
    if (fe25519_isnegative(h->X) == ((s[31] >> 7) ? 1 : 0)) {
        fe25519_neg(h->X, h->X);
    }
...
void speer_ed25519_sign(uint8_t sig[64], const uint8_t* msg, size_t msg_len, const uint8_t pk[32], const uint8_t sk[32]) {
    uint8_t h[64];
...
int speer_ed25519_verify(const uint8_t sig[64], const uint8_t* msg, size_t msg_len, const uint8_t pk[32]) {
